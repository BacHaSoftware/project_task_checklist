...
var ChkSectionListRenderer = ListRenderer.extend({
    init: function (parent, state, params) {
        this.sectionFieldName = "is_title";
...
var ChkSectionFieldOne2Many = FieldOne2Many.extend({
...
FieldRegistry.add('checklist_title_one2many', ChkSectionFieldOne2Many);
